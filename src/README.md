...
- `slides/`: slides 内容系统。负责 model、parsing、compiling、MDX 编译链路。
- `features/`: 产品能力层。按 presenter、navigation、reveal、presentation 等能力分组。
- `features/presentation/stage/`: slide 舞台播放与交互层，承接缩放、cursor、stage click、draw overlay 等舞台语义。
